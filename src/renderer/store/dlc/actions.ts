...
export const contractSuccess = (contracts: ContractSimple[]) =>
...
export const offerRequest = (contract: ContractSimple) =>
...
export const dlcActionSuccess = (contract: ContractSimple) =>
  action(DlcActionTypes.DLC_ACTION_SUCCESS, contract)
export const dlcActionError = (error: string) =>
  action(DlcActionTypes.DLC_ACTION_ERROR, error)
export const dlcUpdate = (contract: ContractSimple) =>
